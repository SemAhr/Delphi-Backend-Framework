...
function TParameterBinder.FromQuery(const AContext: THttpContext; const ADescriptor: TParameterDescriptor): TValue;
var
  RawValue: string;
  ErrorMessage: string;
begin
...
begin
  Result := FBodyBinder.Execute(AContext.Request.Body, ADescriptor.ParameterType);
end;
